...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('comp_app', '0002_alter_computer_image'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ManyToManyField(to='comp_app.computer')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comp_app.customuser')),
            ],
        ),
    ]
